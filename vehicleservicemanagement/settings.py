...
AWS_STORAGE_BUCKET_NAME = "cpp-s3-x24244228"
...
DATABASES = {
    'default': {
        ...
        'NAME': 'cpp-rds-x24244228',
        'USER': 'postgres',
        'PASSWORD': 'cpp-rds-x24244228',
        'HOST': 'cpp-rds-x24244228.c06cswmyir8d.us-east-1.rds.amazonaws.com',
        'PORT': '5432',
        'OPTIONS': {
            'sslmode': 'require',
